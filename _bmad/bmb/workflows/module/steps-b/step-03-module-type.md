...
Make the EARLY key decision: Is this a Standalone, Extension, or Global module? This decision affects everything that
follows.
...
"**Before we go further, we need to decide: What type of module is this?** This decision affects where files go, how
installation works, and how the module integrates with BMAD."
