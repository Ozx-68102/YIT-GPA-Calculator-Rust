...
**Use cases:** Instruction style validation, collaborative quality assessment, frontmatter compliance, step type
validation
...
**Example:** Instead of sequential checks, launch 3 subprocesses in parallel (frontmatter, menu, step types), then
aggregate.
