...
To determine the 4 key structural decisions that define how the workflow will be built: module affiliation, continuable
vs single-session, tri-modal vs create-only, and document output.
...
- [If unclear from discovery] "Does this workflow produce a document or file at the end? A report, a plan, a story, a
  checklist?"
