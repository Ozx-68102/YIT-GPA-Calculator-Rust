...
To create the workflow folder structure, the main workflow.md file, and the primary output template(s) that step files
will reference.
...
Display: **Foundation Complete - Select an Option:** [A] Advanced Elicitation [P] Party Mode [C] Continue to Step 01
Build
...
- IF C: Save foundation summary to {workflowPlanFile}, update frontmatter stepsCompleted, then load, read entire file,
