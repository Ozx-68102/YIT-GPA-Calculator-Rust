...
Understand what the user wants to edit in the PRD, detect PRD format/type, check for validation report guidance, and
route appropriately.
...
This file defines what makes a great BMAD PRD. Internalize this understanding - it will guide improvement
recommendations.
...
**Master Rule:** Understand before editing. Detect format early so we can guide users appropriately. Auto-detect and use
validation reports for prioritized improvements.
