...
Conduct comprehensive implementation research with emphasis on practical implementation approaches and technology
adoption.
...
`{project-root}/_bmad/bmm/workflows/1-analysis/research/technical-steps/step-06-research-synthesis.md` to produce the
comprehensive technical research document with narrative introduction, detailed TOC, and executive summary.
